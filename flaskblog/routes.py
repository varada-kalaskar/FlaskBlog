...
from flaskblog.forms import RegistrationForm, LoginForm, UserAccountForm, NewPostForm, RequestResetForm, ResetPasswordForm
...
def account():
    ...
    image_profile = url_for('static', filename = "profile_pics/" + current_user.image_file )
    return render_template('account.html', title='Account', image = image_profile, form=form)
...
def update_post(post_id):
    ...
    return render_template('new_post.html', title='Update Post', form=form, legend="Update")
